...
we initially restrict our attention to policies induced by some
rationality $\rat$ (as in the MDP case). Conceptually, $\rat$ then enables
$\pOne$ to associate ``comparable'' points on the two Pareto fronts, and
thus reason locally.

More precisely, our algorithm (temporarily) assumes that in the $\pTwo$-node,
