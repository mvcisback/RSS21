...
recursively until the sinks of the game graph.  We call the increase
...
direction by increasing the rationality.  \todo[inline]{Visualize this
  ...
  for MDP subroutine} Thus, by traversing the graph from the sinks to
the root, approximating Pareto Fronts along the way, one can memoize
