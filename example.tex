...
Rather than the pessimistic adversarial assumption, we may collect data about $\droneEnv$ and construct a stochastic model, e.g., using inverse reinforcement learning~\sj{cite}\cite{}.
...
\mypara{Adversarial and Stochastic Model} However, a natural criticism for stochastic
