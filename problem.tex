...
the following assumptions\footnote{W.l.o.g. due to causal entropy and reachability
  being computable via Bellman backup (e.g. dynamic programming recursively on subgraphs)
}: We assume the graph
