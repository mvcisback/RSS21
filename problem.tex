...
%While most synthesis problems either consider soft \emph{or} hard constraints, it is natural to also consider a setting with both types of constraints~\cite{}. Such a problem formulation would be:
% \begin{mdframed}{}
