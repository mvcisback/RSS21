...
The use of declarative specifications to define high-level plans, e.g.,\sj{is this about plans or about specs?}
...
example, consider a patrol\sj{Still patrol?} drone operating in a workspace. One may
...
In summary, this paper contributes ERCI, an algorithmic way to trade\sj{first occurance of trading}
