...
\begin{abstract}
  ...
  In many contexts, e.g., patrolling, testing, behavior predication,
  ...
  To address these concerns, we introduce the \emph{Entropic Reactive
    Control Improvisation} (ERCI) framework and algorithm that
  ...
  specifying the unpredictability (causal entropy) and variety of the
  controller.
  ...
  in the environment, enables a flexible modeling formalism which, as
  we demonstrate theoretically and empirically, remains tractable.
\end{abstract}
