...
\newcommand{\smoothmax}[2]{\mathsf{smax}_{#1}^{#2}}
...
We define the following smooth variant of the Bellman equations. In particular, we use $\smoothmax{}{}$ as the log-sum-exp 
\begin{align}
	V_\rat(s) \colonequals  \smoothmax{\act \in \Act}{\rat} \{  Q(s,\act) \} \\ 
	Q_\rat(s)
\end{align}
