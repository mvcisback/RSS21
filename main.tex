...
\label{sec:problem}
This section formalizes the novel Entropic Reactive Control
Improvisation (ERCI) problem.  We start with some necessary
definitions and notations on stochastic games.
